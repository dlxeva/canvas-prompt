...
def build_compact_caption_summary(caption_track: list, max_items: int = 10) -> list:
    """将 caption track 压缩成 compact_caption_summary"""
    summary = []
    for cap in caption_track[:max_items]:
        summary.append({
...
def build_compact_package(fixture_dir: Path) -> dict:
    ...
    compact_caption_summary = build_compact_caption_summary(caption_track)
