    ...
    return {
        ...
        "summary": {
            ...
            "structural_observation_count": sum(
                ...
                for field in ("reference_candidates", "ink_relation_candidates", "ink_circle_candidates", "ink_arrowhead_candidates", "ink_cross_candidates", "ink_check_candidates", "paired_symbol_choice_candidates", "visual_unit_candidates")
            ),
