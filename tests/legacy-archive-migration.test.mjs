...
const fixtureRound = async (archiveDir, packageId, content = packageId) => {
  ...
  await writeFile(resolve(roundDir, 'round.json'), `${JSON.stringify({ package_id: packageId, status: 'engine_compiled' })}\n`)
